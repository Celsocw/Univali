	...
	*/
		...
		$all_tables = [
			/* ['table_name' => [table props assoc array] */   
				...
				'Eleitores' => [
					'Caption' => 'Eleitores',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/email_to_friend.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
				'Candidatos' => [
				...
				'Funcoes' => [
					'Caption' => 'Fun&#231;&#245;es',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/draw_airbrush.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
				'Estados' => [
					'Caption' => 'Estados',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/map_magnify.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
				'Municipios' => [
				...
				'Bairro' => [
					'Caption' => 'Bairro',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/map_go.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
				'Zona' => [
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/radiolocator.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
				'Secao' => [
					'Caption' => 'Se&#231;&#227;o Eleitoral',
					'Description' => '',
				...
				'Agenda' => [
					'Caption' => 'Agenda',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/book_addresses.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
				'Atendimentos' => [
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/horoscopes.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				],
		];
	...
	function getTableList($skip_authentication = false, $include_internal_tables = false) {
		...
		$arrTables = [
			...
			'Pessoas' => ['Cadastros', '', 'resources/table_icons/group_add.png', 'None'],
			'Eleitores' => ['Eleitores', '', 'resources/table_icons/email_to_friend.png', 'None'],
			'Candidatos' => ['Candidatos', '', 'resources/table_icons/reseller_programm.png', 'None'],
			'Colaboradores' => ['Colaboradores', '', 'resources/table_icons/premium_support.png', 'None'],
			'Partidos' => ['Partidos', '', 'resources/table_icons/entity.png', 'None'],
			'Profissoes' => ['Profiss&#245;es', '', 'resources/table_icons/chair.png', 'None'],
			'Funcoes' => ['Fun&#231;&#245;es', '', 'resources/table_icons/draw_airbrush.png', 'None'],
			'Estados' => ['Estados', '', 'resources/table_icons/map_magnify.png', 'None'],
			'Municipios' => ['Munic&#237;pios', '', 'resources/table_icons/google_map.png', 'None'],
			'Bairro' => ['Bairro', '', 'resources/table_icons/map_go.png', 'None'],
			'Zona' => ['Zona Eleitoral', '', 'resources/table_icons/radiolocator.png', 'None'],
			'Secao' => ['Se&#231;&#227;o Eleitoral', '', 'resources/table_icons/routing_turn_left_crossroads.png', 'None'],
			'Agenda' => ['Agenda', '', 'resources/table_icons/book_addresses.png', 'None'],
			'Atendimentos' => ['Atendimentos', '', 'resources/table_icons/horoscopes.png', 'None'],
		];
		...
		if($schema === null) {
			...
			$schema = [
				'Pessoas' => [
					...
					'Nome' => [
						'appgini' => "VARCHAR(120) NOT NULL UNIQUE",
						'info' => [
							'caption' => 'Nome',
							'description' => '',
						],
					...
					'CEP' => [
						'appgini' => "VARCHAR(12) NULL UNIQUE",
						'info' => [
							'caption' => 'CEP',
							'description' => '',
						],
					...
					'Midias' => [
						...
						'info' => [
							'caption' => 'Midias Sociais',
							'description' => 'Midias sociais como instagram, Facebook ...',
						],
					],
					'Obs' => [
						'appgini' => "TEXT NULL",
				...
				'Eleitores' => [
					...
					'Mae' => [
						...
						'info' => [
							'caption' => 'M&#226;e',
							'description' => 'Digite o nome da m&#227;e como na carteira de identidade',
						],
					],
					'DataN' => [
						'appgini' => "DATE NULL",
					...
					'CPF' => [
						'appgini' => "VARCHAR(15) NULL UNIQUE",
						'info' => [
							'caption' => 'CPF',
							'description' => '',
						],
				...
				'Candidatos' => [
					...
					'Numero' => [
						'appgini' => "INT(5) UNSIGNED NOT NULL",
						'info' => [
							'caption' => 'Numero',
							'description' => '',
						],
				...
				'Colaboradores' => [
					...
					'Profissao' => [
						...
						'info' => [
							'caption' => 'Profiss&#227;o',
							'description' => 'Profiss&#227;o do colaborador',
						],
					],
					'Funcao' => [
						'appgini' => "INT(10) UNSIGNED NOT NULL",
					...
					'Responsavel' => [
						...
						'info' => [
							'caption' => 'Responsavel',
							'description' => 'Membro da equipe respons&#225;vel pelo colaborador',
						],
					],
					'Obs' => [
						'appgini' => "TEXT NULL",
				...
				'Partidos' => [
					...
					'Nome' => [
						...
						'info' => [
							'caption' => 'Nome',
							'description' => 'Digite o nome do partido',
						],
					],
					'Numero' => [
						'appgini' => "INT(5) NULL",
				...
				'Profissoes' => [
					...
					'Seguimento' => [
						...
						'info' => [
							'caption' => 'Seguimento',
							'description' => 'Sa&#250;de, Educa&#231;&#227;o, Direito ...',
						],
					],
				],
				'Funcoes' => [
					...
					'Nome' => [
						'appgini' => "VARCHAR(80) NOT NULL UNIQUE",
						'info' => [
							'caption' => 'Nome',
							'description' => 'Fun&#231;&#245;es exercidas pelos colaboradores como motorista, planfeteiro ou coordenador de campanha',
						],
					],
				],
				'Estados' => [
				...
				'Secao' => [
					...
					'Numero' => [
						'appgini' => "VARCHAR(250) NOT NULL",
						'info' => [
							'caption' => 'Numero',
							'description' => 'numero da sess&#227;o',
						],
					],
					'Cidade' => [
						'appgini' => "INT UNSIGNED NOT NULL",
					...
					'Endereco' => [
						...
						'info' => [
							'caption' => 'Endere&#231;o',
							'description' => 'Endere&#231;o do local da vota&#231;&#227;o',
						],
					],
					'Local' => [
						'appgini' => "VARCHAR(100) NOT NULL",
				...
				'Atendimentos' => [
					...
					'Colaborador' => [
						...
						'info' => [
							'caption' => 'Colaborador',
							'description' => 'Colaborador, assessor ou atendente que cadastro o atendimento.',
						],
					],
					'Eleitor' => [
						'appgini' => "INT UNSIGNED NOT NULL",
					...
					'Pedido' => [
						...
						'info' => [
							'caption' => 'Descri&#231;&#227;o dos pedidos',
							'description' => 'QUal o pedido do pedinte?',
						],
					],
					'Pendencias' => [
						'appgini' => "TEXT NULL",
						'info' => [
							'caption' => 'Pend&#234;ncias',
							'description' => 'Descri&#231;&#227;o da pendencia, se houver;',
						],
					],
					'Solucao' => [
						'appgini' => "TEXT NULL",
	...
	*/
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			'Pessoas' => [
				'Estado' => 'SELECT `Estados`.`id`, IF(CHAR_LENGTH(`Estados`.`Nome`) || CHAR_LENGTH(`Estados`.`Sigla`), CONCAT_WS(\'\', `Estados`.`Nome`, \'    -    \', `Estados`.`Sigla`), \'\') FROM `Estados` ORDER BY 2',
				'Cidade' => 'SELECT `Municipios`.`Id`, `Municipios`.`Nome` FROM `Municipios` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Municipios`.`Estado` ORDER BY 2',
				'Bairro' => 'SELECT `Bairro`.`Id`, `Bairro`.`Nome` FROM `Bairro` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Bairro`.`Cidade` ORDER BY 2',
				'profissao' => 'SELECT `Profissoes`.`id`, IF(CHAR_LENGTH(`Profissoes`.`Profissao`) || CHAR_LENGTH(`Profissoes`.`Seguimento`), CONCAT_WS(\'\', `Profissoes`.`Profissao`, \'   -   \', `Profissoes`.`Seguimento`), \'\') FROM `Profissoes` ORDER BY 2',
			],
			'Eleitores' => [
				'Nome' => 'SELECT `Pessoas`.`Id`, `Pessoas`.`Nome` FROM `Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ORDER BY 2',
				'Estado' => 'SELECT `Pessoas`.`Id`, IF(    CHAR_LENGTH(`Estados1`.`Nome`) || CHAR_LENGTH(`Estados1`.`Sigla`), CONCAT_WS(\'\',   `Estados1`.`Nome`, \'    -    \', `Estados1`.`Sigla`), \'\') FROM `Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ORDER BY 2',
				'Cidade' => 'SELECT `Pessoas`.`Id`, IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS(\'\',   `Municipios1`.`Nome`), \'\') FROM `Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ORDER BY 2',
				'Bairro' => 'SELECT `Pessoas`.`Id`, IF(    CHAR_LENGTH(`Bairro1`.`Nome`), CONCAT_WS(\'\',   `Bairro1`.`Nome`), \'\') FROM `Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ORDER BY 2',
				'Zona' => 'SELECT `Zona`.`id`, `Zona`.`Numero` FROM `Zona` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Zona`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona`.`Municipio` ORDER BY 2',
				'secao' => 'SELECT `Secao`.`id`, IF(CHAR_LENGTH(`Secao`.`Numero`), CONCAT_WS(\'\', `Secao`.`Numero`, \'    -    \'), \'\') FROM `Secao` LEFT JOIN `Zona` as Zona1 ON `Zona1`.`id`=`Secao`.`Cidade` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona1`.`Municipio` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Secao`.`Bairro` LEFT JOIN `Zona` as Zona2 ON `Zona2`.`id`=`Secao`.`Zona` ORDER BY 2',
				'local' => 'SELECT `Secao`.`id`, `Secao`.`Local` FROM `Secao` LEFT JOIN `Zona` as Zona1 ON `Zona1`.`id`=`Secao`.`Cidade` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona1`.`Municipio` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Secao`.`Bairro` LEFT JOIN `Zona` as Zona2 ON `Zona2`.`id`=`Secao`.`Zona` ORDER BY 2',
				'partido' => 'SELECT `Partidos`.`id`, `Partidos`.`Sigla` FROM `Partidos` ORDER BY 2',
				'indicacao' => 'SELECT `Colaboradores`.`Id`, IF(CHAR_LENGTH(`Colaboradores`.`Nome`) || CHAR_LENGTH(`Colaboradores`.`Funcao`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS(\'\',   `Pessoas1`.`Nome`), \'\'), \'    -    \', IF(    CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS(\'\',   `Funcoes1`.`Nome`), \'\')), \'\') FROM `Colaboradores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Colaboradores`.`Nome` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Colaboradores`.`Profissao` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores`.`Funcao` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Colaboradores`.`Responsavel` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes2 ON `Funcoes2`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ORDER BY 2',
			],
			'Candidatos' => [
				'Partido' => 'SELECT `Partidos`.`id`, IF(CHAR_LENGTH(`Partidos`.`Sigla`) || CHAR_LENGTH(`Partidos`.`Numero`), CONCAT_WS(\'\', `Partidos`.`Sigla`, \'   -   \', `Partidos`.`Numero`), \'\') FROM `Partidos` ORDER BY 2',
				'Nome' => 'SELECT `Eleitores`.`id`, IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS(\'\',   `Pessoas1`.`Nome`), \'\') FROM `Eleitores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Eleitores`.`Nome` LEFT JOIN `Zona` as Zona1 ON `Zona1`.`id`=`Eleitores`.`Zona` LEFT JOIN `Secao` as Secao1 ON `Secao1`.`id`=`Eleitores`.`secao` LEFT JOIN `Partidos` as Partidos1 ON `Partidos1`.`id`=`Eleitores`.`partido` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Eleitores`.`indicacao` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas1`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas1`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ORDER BY 2',
			],
			'Colaboradores' => [
				'Nome' => 'SELECT `Pessoas`.`Id`, `Pessoas`.`Nome` FROM `Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ORDER BY 2',
				'Bairro' => 'SELECT `Pessoas`.`Id`, IF(    CHAR_LENGTH(`Bairro1`.`Nome`), CONCAT_WS(\'\',   `Bairro1`.`Nome`), \'\') FROM `Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ORDER BY 2',
				'Profissao' => 'SELECT `Profissoes`.`id`, IF(CHAR_LENGTH(`Profissoes`.`Profissao`) || CHAR_LENGTH(`Profissoes`.`Seguimento`), CONCAT_WS(\'\', `Profissoes`.`Profissao`, \'   -   \', `Profissoes`.`Seguimento`), \'\') FROM `Profissoes` ORDER BY 2',
				'Funcao' => 'SELECT `Funcoes`.`Id`, `Funcoes`.`Nome` FROM `Funcoes` ORDER BY 2',
				'Responsavel' => 'SELECT `Colaboradores`.`Id`, IF(CHAR_LENGTH(`Colaboradores`.`Nome`) || CHAR_LENGTH(`Colaboradores`.`Funcao`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS(\'\',   `Pessoas1`.`Nome`), \'\'), \'   -   \', IF(    CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS(\'\',   `Funcoes1`.`Nome`), \'\')), \'\') FROM `Colaboradores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Colaboradores`.`Nome` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Colaboradores`.`Profissao` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores`.`Funcao` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Colaboradores`.`Responsavel` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes2 ON `Funcoes2`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ORDER BY 2',
			],
			'Partidos' => [
			],
			'Profissoes' => [
			...
			'Zona' => [
				'Estado' => 'SELECT `Estados`.`id`, IF(CHAR_LENGTH(`Estados`.`Nome`) || CHAR_LENGTH(`Estados`.`Sigla`), CONCAT_WS(\'\', `Estados`.`Nome`, \'    -    \', `Estados`.`Sigla`), \'\') FROM `Estados` ORDER BY 2',
				'Municipio' => 'SELECT `Municipios`.`Id`, `Municipios`.`Nome` FROM `Municipios` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Municipios`.`Estado` ORDER BY 2',
			],
			'Secao' => [
				'Cidade' => 'SELECT `Zona`.`id`, IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS(\'\',   `Municipios1`.`Nome`), \'\') FROM `Zona` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Zona`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona`.`Municipio` ORDER BY 2',
				'Bairro' => 'SELECT `Bairro`.`Id`, `Bairro`.`Nome` FROM `Bairro` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Bairro`.`Cidade` ORDER BY 2',
				'Zona' => 'SELECT `Zona`.`id`, `Zona`.`Numero` FROM `Zona` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Zona`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona`.`Municipio` ORDER BY 2',
			],
			'Agenda' => [
			...
			'Atendimentos' => [
				'Colaborador' => 'SELECT `Colaboradores`.`Id`, IF(CHAR_LENGTH(`Colaboradores`.`Nome`) || CHAR_LENGTH(`Colaboradores`.`Funcao`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS(\'\',   `Pessoas1`.`Nome`), \'\'), \'    -    \', IF(    CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS(\'\',   `Funcoes1`.`Nome`), \'\')), \'\') FROM `Colaboradores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Colaboradores`.`Nome` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Colaboradores`.`Profissao` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores`.`Funcao` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Colaboradores`.`Responsavel` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes2 ON `Funcoes2`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ORDER BY 2',
				'Eleitor' => 'SELECT `Eleitores`.`id`, IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS(\'\',   `Pessoas1`.`Nome`), \'\') FROM `Eleitores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Eleitores`.`Nome` LEFT JOIN `Zona` as Zona1 ON `Zona1`.`id`=`Eleitores`.`Zona` LEFT JOIN `Secao` as Secao1 ON `Secao1`.`id`=`Eleitores`.`secao` LEFT JOIN `Partidos` as Partidos1 ON `Partidos1`.`id`=`Eleitores`.`partido` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Eleitores`.`indicacao` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas1`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas1`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ORDER BY 2',
			],
		];
