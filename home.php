...
<?php
	...
	if(is_array($arrTables) && count($arrTables)) {
		...
		foreach($tg as $tn => $tgroup) {
			...
			$tChkAHAN = array_search($tn, ['Pessoas','Eleitores','Candidatos','Colaboradores','Partidos','Profissoes','Funcoes','Estados','Municipios','Bairro','Zona','Secao','Agenda','Atendimentos']);
