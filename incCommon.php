<?php
	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			'Pessoas' => "`Pessoas`.`Id` as 'Id', `Pessoas`.`Nome` as 'Nome', IF(    CHAR_LENGTH(`Estados1`.`Nome`) || CHAR_LENGTH(`Estados1`.`Sigla`), CONCAT_WS('',   `Estados1`.`Nome`, '    -    ', `Estados1`.`Sigla`), '') as 'Estado', IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS('',   `Municipios1`.`Nome`), '') as 'Cidade', IF(    CHAR_LENGTH(`Bairro1`.`Nome`), CONCAT_WS('',   `Bairro1`.`Nome`), '') as 'Bairro', `Pessoas`.`Rua` as 'Rua', `Pessoas`.`numero` as 'numero', `Pessoas`.`CEP` as 'CEP', `Pessoas`.`Contato` as 'Contato', IF(    CHAR_LENGTH(`Profissoes1`.`Profissao`) || CHAR_LENGTH(`Profissoes1`.`Seguimento`), CONCAT_WS('',   `Profissoes1`.`Profissao`, '   -   ', `Profissoes1`.`Seguimento`), '') as 'profissao', `Pessoas`.`Email` as 'Email', `Pessoas`.`Midias` as 'Midias', `Pessoas`.`Obs` as 'Obs'",
			'Eleitores' => "`Eleitores`.`id` as 'id', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS('',   `Pessoas1`.`Nome`), '') as 'Nome', `Eleitores`.`Mae` as 'Mae', if(`Eleitores`.`DataN`,date_format(`Eleitores`.`DataN`,'%d/%m/%Y'),'') as 'DataN', `Eleitores`.`CPF` as 'CPF', `Eleitores`.`Titulo` as 'Titulo', IF(    CHAR_LENGTH(`Estados1`.`Nome`) || CHAR_LENGTH(`Estados1`.`Sigla`), CONCAT_WS('',   `Estados1`.`Nome`, '    -    ', `Estados1`.`Sigla`), '') as 'Estado', IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS('',   `Municipios1`.`Nome`), '') as 'Cidade', IF(    CHAR_LENGTH(`Bairro1`.`Nome`), CONCAT_WS('',   `Bairro1`.`Nome`), '') as 'Bairro', IF(    CHAR_LENGTH(`Zona1`.`Numero`), CONCAT_WS('',   `Zona1`.`Numero`), '') as 'Zona', IF(    CHAR_LENGTH(`Secao1`.`Numero`), CONCAT_WS('',   `Secao1`.`Numero`, '    -    '), '') as 'secao', IF(    CHAR_LENGTH(`Secao1`.`Local`), CONCAT_WS('',   `Secao1`.`Local`), '') as 'local', IF(    CHAR_LENGTH(`Partidos1`.`Sigla`), CONCAT_WS('',   `Partidos1`.`Sigla`), '') as 'partido', IF(    CHAR_LENGTH(`Pessoas2`.`Nome`) || CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS('',   `Pessoas2`.`Nome`, '    -    ', `Funcoes1`.`Nome`), '') as 'indicacao'",
			'Candidatos' => "`Candidatos`.`id` as 'id', IF(    CHAR_LENGTH(`Partidos1`.`Sigla`) || CHAR_LENGTH(`Partidos1`.`Numero`), CONCAT_WS('',   `Partidos1`.`Sigla`, '   -   ', `Partidos1`.`Numero`), '') as 'Partido', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS('',   `Pessoas1`.`Nome`), '') as 'Nome', `Candidatos`.`Numero` as 'Numero', `Candidatos`.`Cargo` as 'Cargo', `Candidatos`.`Midias` as 'Midias'",
			'Colaboradores' => "`Colaboradores`.`Id` as 'Id', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`), CONCAT_WS('',   `Pessoas1`.`Nome`), '') as 'Nome', IF(    CHAR_LENGTH(`Bairro1`.`Nome`), CONCAT_WS('',   `Bairro1`.`Nome`), '') as 'Bairro', IF(    CHAR_LENGTH(`Profissoes1`.`Profissao`) || CHAR_LENGTH(`Profissoes1`.`Seguimento`), CONCAT_WS('',   `Profissoes1`.`Profissao`, '   -   ', `Profissoes1`.`Seguimento`), '') as 'Profissao', IF(    CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS('',   `Funcoes1`.`Nome`), '') as 'Funcao', IF(    CHAR_LENGTH(`Pessoas2`.`Nome`) || CHAR_LENGTH(`Funcoes2`.`Nome`), CONCAT_WS('',   `Pessoas2`.`Nome`, '   -   ', `Funcoes2`.`Nome`), '') as 'Responsavel', `Colaboradores`.`Obs` as 'Obs'",
			'Partidos' => "`Partidos`.`id` as 'id', `Partidos`.`Nome` as 'Nome', `Partidos`.`Numero` as 'Numero', `Partidos`.`Sigla` as 'Sigla'",
			'Profissoes' => "`Profissoes`.`id` as 'id', `Profissoes`.`Profissao` as 'Profissao', `Profissoes`.`Seguimento` as 'Seguimento'",
			'Funcoes' => "`Funcoes`.`Id` as 'Id', `Funcoes`.`Nome` as 'Nome'",
			'Estados' => "`Estados`.`id` as 'id', `Estados`.`Nome` as 'Nome', `Estados`.`Sigla` as 'Sigla'",
			'Municipios' => "`Municipios`.`Id` as 'Id', `Municipios`.`Nome` as 'Nome', IF(    CHAR_LENGTH(`Estados1`.`Nome`) || CHAR_LENGTH(`Estados1`.`Sigla`), CONCAT_WS('',   `Estados1`.`Nome`, '    -    ', `Estados1`.`Sigla`), '') as 'Estado'",
			'Bairro' => "`Bairro`.`Id` as 'Id', `Bairro`.`Nome` as 'Nome', IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS('',   `Municipios1`.`Nome`), '') as 'Cidade'",
			'Zona' => "`Zona`.`id` as 'id', `Zona`.`Numero` as 'Numero', IF(    CHAR_LENGTH(`Estados1`.`Nome`) || CHAR_LENGTH(`Estados1`.`Sigla`), CONCAT_WS('',   `Estados1`.`Nome`, '    -    ', `Estados1`.`Sigla`), '') as 'Estado', IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS('',   `Municipios1`.`Nome`), '') as 'Municipio'",
			'Secao' => "`Secao`.`id` as 'id', `Secao`.`Numero` as 'Numero', IF(    CHAR_LENGTH(`Municipios1`.`Nome`), CONCAT_WS('',   `Municipios1`.`Nome`), '') as 'Cidade', IF(    CHAR_LENGTH(`Bairro1`.`Nome`), CONCAT_WS('',   `Bairro1`.`Nome`), '') as 'Bairro', IF(    CHAR_LENGTH(`Zona2`.`Numero`), CONCAT_WS('',   `Zona2`.`Numero`), '') as 'Zona', `Secao`.`Endereco` as 'Endereco', `Secao`.`Local` as 'Local', `Secao`.`Eleitores` as 'Eleitores'",
			'Agenda' => "`Agenda`.`Id` as 'Id', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`) || CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS('',   `Pessoas1`.`Nome`, '     -     ', `Funcoes1`.`Nome`), '') as 'Responsavel', if(`Agenda`.`Data`,date_format(`Agenda`.`Data`,'%d/%m/%Y'),'') as 'Data', `Agenda`.`Hora` as 'Hora', `Agenda`.`Evento` as 'Evento', `Agenda`.`Local` as 'Local', `Agenda`.`Obs` as 'Obs'",
			'Atendimentos' => "`Atendimentos`.`id` as 'id', IF(    CHAR_LENGTH(`Pessoas1`.`Nome`) || CHAR_LENGTH(`Funcoes1`.`Nome`), CONCAT_WS('',   `Pessoas1`.`Nome`, '    -    ', `Funcoes1`.`Nome`), '') as 'Colaborador', IF(    CHAR_LENGTH(`Pessoas2`.`Nome`), CONCAT_WS('',   `Pessoas2`.`Nome`), '') as 'Eleitor', if(`Atendimentos`.`Data`,date_format(`Atendimentos`.`Data`,'%d/%m/%Y'),'') as 'Data', `Atendimentos`.`Situacao` as 'Situacao', `Atendimentos`.`Pedido` as 'Pedido', `Atendimentos`.`Pendencias` as 'Pendencias', `Atendimentos`.`Solucao` as 'Solucao'",
		];
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false, $lower_permissions = false) {
		$sql_from = [
			'Pessoas' => "`Pessoas` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas`.`Bairro` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Pessoas`.`profissao` ",
			'Eleitores' => "`Eleitores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Eleitores`.`Nome` LEFT JOIN `Zona` as Zona1 ON `Zona1`.`id`=`Eleitores`.`Zona` LEFT JOIN `Secao` as Secao1 ON `Secao1`.`id`=`Eleitores`.`secao` LEFT JOIN `Partidos` as Partidos1 ON `Partidos1`.`id`=`Eleitores`.`partido` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Eleitores`.`indicacao` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Pessoas1`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Pessoas1`.`Cidade` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ",
			'Candidatos' => "`Candidatos` LEFT JOIN `Partidos` as Partidos1 ON `Partidos1`.`id`=`Candidatos`.`Partido` LEFT JOIN `Eleitores` as Eleitores1 ON `Eleitores1`.`id`=`Candidatos`.`Nome` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Eleitores1`.`Nome` ",
			'Colaboradores' => "`Colaboradores` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Colaboradores`.`Nome` LEFT JOIN `Profissoes` as Profissoes1 ON `Profissoes1`.`id`=`Colaboradores`.`Profissao` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores`.`Funcao` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Colaboradores`.`Responsavel` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes2 ON `Funcoes2`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Pessoas1`.`Bairro` ",
			'Partidos' => "`Partidos` ",
			'Profissoes' => "`Profissoes` ",
			'Funcoes' => "`Funcoes` ",
			'Estados' => "`Estados` ",
			'Municipios' => "`Municipios` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Municipios`.`Estado` ",
			'Bairro' => "`Bairro` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Bairro`.`Cidade` ",
			'Zona' => "`Zona` LEFT JOIN `Estados` as Estados1 ON `Estados1`.`id`=`Zona`.`Estado` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona`.`Municipio` ",
			'Secao' => "`Secao` LEFT JOIN `Zona` as Zona1 ON `Zona1`.`id`=`Secao`.`Cidade` LEFT JOIN `Municipios` as Municipios1 ON `Municipios1`.`Id`=`Zona1`.`Municipio` LEFT JOIN `Bairro` as Bairro1 ON `Bairro1`.`Id`=`Secao`.`Bairro` LEFT JOIN `Zona` as Zona2 ON `Zona2`.`id`=`Secao`.`Zona` ",
			'Agenda' => "`Agenda` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Agenda`.`Responsavel` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores1`.`Funcao` ",
			'Atendimentos' => "`Atendimentos` LEFT JOIN `Colaboradores` as Colaboradores1 ON `Colaboradores1`.`Id`=`Atendimentos`.`Colaborador` LEFT JOIN `Pessoas` as Pessoas1 ON `Pessoas1`.`Id`=`Colaboradores1`.`Nome` LEFT JOIN `Funcoes` as Funcoes1 ON `Funcoes1`.`Id`=`Colaboradores1`.`Funcao` LEFT JOIN `Eleitores` as Eleitores1 ON `Eleitores1`.`id`=`Atendimentos`.`Eleitor` LEFT JOIN `Pessoas` as Pessoas2 ON `Pessoas2`.`Id`=`Eleitores1`.`Nome` ",
		];
...
EOT;
	...
	function isDetailViewEnabled($tn) {
		$tables = ['Pessoas', 'Eleitores', 'Candidatos', 'Colaboradores', 'Partidos', 'Profissoes', 'Funcoes', 'Estados', 'Municipios', 'Bairro', 'Zona', 'Secao', 'Agenda', 'Atendimentos', ];
